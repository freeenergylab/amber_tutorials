...
cluster Cluster1  hieragglo epsilon 3.0 clusters 10 averagelinkage  rms :2-128@CA  sieve 10 random  out clustersnum_vs_time.dat  summary summary.dat  info info.dat  cpopvtime clusterspop_vs_time.agr normframe  repout rep repfmt pdb  singlerepout singlerep.pdb singlerepfmt pdb  avgout avg avgfmt pdb
run
EOF
